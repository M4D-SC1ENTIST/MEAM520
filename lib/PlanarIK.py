...
class PlanarIK:
    ...
    def rrr_abstract_ik(self, target):
        ...
        #q3_a = pi-t_theta+q1_a-q2_a
        #q3_b = pi-t_theta+q1_b-q2_b
        #
        #q3_a = q1_a-q2_a-t_theta
        #q3_b = q1_b-q2_b-t_theta
        

        print('!!!!!!!!!!!!Attention for Debugging output:\n')
        print(np.array([[q1_a, q2_a, q3_a], [q1_b, q2_b, q3_b]]))
